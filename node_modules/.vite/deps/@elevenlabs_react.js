...
var h = (i2, s, t2) => s in i2 ? e(i2, s, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t2
}) : i2[s] = t2;
var o = (i2, s, t2) => h(i2, typeof s != "symbol" ? s + "" : s, t2);
var _ = class {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
...
function makeMessageType(runtime, typeName, fields, opt) {
  ...
  Object.assign(type, {
    ...
    equals(a3, b2) {
      return runtime.util.equals(type, a3, b2);
    }
  });
  return type;
}
...
function scalarEquals(type, a3, b2) {
  if (a3 === b2) {
    return true;
  }
  if (type == ScalarType.BYTES) {
    if (!(a3 instanceof Uint8Array) || !(b2 instanceof Uint8Array)) {
      return false;
    }
  ...
  return {
    ...
    initPartial(source, target) {
      ...
      for (const member of type.fields.byMember()) {
        const localName = member.localName, t2 = target, s = source;
        if (s[localName] == null) {
          continue;
        }
        switch (member.kind) {
            ...
            switch (member.V.kind) {
              ...
              case "enum":
                if (member.V.T === ScalarType.BYTES) {
                  ...
                  Object.assign(t2[localName], s[localName]);
                }
                break;
              case "message":
          ...
          case "message":
            const mt = member.T;
            if (member.repeated) {
              t2[localName] = s[localName].map((val2) => isMessage(val2, mt) ? val2 : new mt(val2));
            } else {
    ...
    equals(type, a3, b2) {
      ...
      return type.fields.byMember().every((m2) => {
        ...
        if (m2.repeated) {
          ...
          switch (m2.kind) {
            case "message":
              return va.every((a4, i2) => m2.T.equals(a4, vb[i2]));
            case "scalar":
              return va.every((a4, i2) => scalarEquals(m2.T, a4, vb[i2]));
            case "enum":
              return va.every((a4, i2) => scalarEquals(ScalarType.INT32, a4, vb[i2]));
          }
...
var InternalFieldList = class {
  ...
  byNumber() {
    if (!this.numbersAsc) {
      this.numbersAsc = this.list().concat().sort((a3, b2) => a3.no - b2.no);
    }
...
var Timestamp = class _Timestamp extends Message {
  ...
  static equals(a3, b2) {
    return proto3.util.equals(_Timestamp, a3, b2);
  }
};
...
function shimGetUserMedia$2(window2, browserDetails2) {
  ...
  const shimConstraints_ = function(constraints, func) {
    ...
    if (constraints && typeof constraints.audio === "object") {
      const remap = function(obj, a3, b2) {
        if (a3 in obj && !(b2 in obj)) {
          obj[b2] = obj[a3];
          delete obj[a3];
        }
      };
...
function areDimensionsSmaller(a3, b2) {
  return a3.width * a3.height < b2.width * b2.height;
}
function layerDimensionsFor(trackInfo, quality) {
  var _a;
  return (_a = trackInfo.layers) === null || _a === void 0 ? void 0 : _a.find((l3) => l3.quality === quality);
}
        ...
        resolve({
          readable: new ReadableStream({
            start(controller) {
              ...
              ws.onerror = (e3) => controller.error(e3);
            },
        ...
        try {
          ...
          const abortHandler = (eventOrError) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.streamWriter && !this.isDisconnected) {
              this.sendLeave().then(() => this.close(reason)).catch((e3) => {
                this.log.error(e3);
                this.close();
              });
            } else {
  ...
  handleConnectionError(reason, validateUrl) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return e3 instanceof ConnectionError ? e3 : new ConnectionError(e3 instanceof Error ? e3.message : "server was not reachable", ConnectionErrorReason.ServerUnreachable);
      }
    });
  }
};
...
function r(r3, e3, n2) {
  ...
  var a3 = null != (i2 = n2.isImmediate) && i2, u3 = null != (t2 = n2.callback) && t2, c2 = n2.maxWait, v2 = Date.now(), l3 = [];
  function f2() {
    if (void 0 !== c2) {
      var r4 = Date.now() - v2;
  ...
  var d2 = function() {
    ...
    return new Promise(function(i3, t3) {
      ...
      if (void 0 !== o3 && clearTimeout(o3), o3 = setTimeout(function() {
        if (o3 = void 0, v2 = Date.now(), !a3) {
          var i4 = r3.apply(n3, e4);
          u3 && u3(i4), l3.forEach(function(r4) {
            return (0, r4.resolve)(i4);
          }), l3 = [];
        }
      }, f2()), c3) {
        var d3 = r3.apply(n3, e4);
        return u3 && u3(d3), i3(d3);
      }
      l3.push({
        resolve: i3,
        reject: t3
  ...
  return d2.cancel = function(r4) {
    void 0 !== o3 && clearTimeout(o3), l3.forEach(function(e4) {
...
var LocalVideoTrack = class extends LocalTrack {
  ...
  getSenderStats() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      items.sort((a3, b2) => {
        var _a2, _b;
        return ((_a2 = b2.frameWidth) !== null && _a2 !== void 0 ? _a2 : 0) - ((_b = a3.frameWidth) !== null && _b !== void 0 ? _b : 0);
      });
      return items;
    });
  }
  ...
  prioritizePerformance() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const params = this.sender.getParameters();
        params.encodings = params.encodings.map((e3, idx) => {
          var _a;
          return Object.assign(Object.assign({}, e3), {
            ...
            maxBitrate: idx === 0 ? e3.maxBitrate : 0
          });
        });
...
var RemoteAudioTrack = class extends RemoteTrack {
  ...
  attach(element) {
    ...
    if (this.sinkId && supportsSetSinkId(element)) {
      element.setSinkId(this.sinkId).catch((e3) => {
      ...
      if (enabled) {
        if (track) {
          ...
          try {
            ...
            if (e3 instanceof Error) {
              this.emit(ParticipantEvent.MediaDevicesError, e3, sourceToKind(source));
            }
...
var Room = class _Room extends eventsExports.EventEmitter {
  ...
  constructor(options) {
    ...
    this.handleSpeakersChanged = (speakerUpdates) => {
      ...
      activeSpeakers.sort((a3, b2) => b2.audioLevel - a3.audioLevel);
      this.activeSpeakers = activeSpeakers;
      this.emitWhenConnected(RoomEvent.ActiveSpeakersChanged, activeSpeakers);
    };
    ...
    this.onMediaDevicesError = (e3, kind) => {
      this.emit(RoomEvent.MediaDevicesError, e3, kind);
    };
    ...
    return __awaiter(this, arguments, void 0, function(kind, deviceId) {
      ...
      return function* () {
        ...
        if (kind === "audioinput") {
          ...
          const isMuted = tracks.some((t2) => {
            var _a2, _b2;
            return (_b2 = (_a2 = t2.track) === null || _a2 === void 0 ? void 0 : _a2.isMuted) !== null && _b2 !== void 0 ? _b2 : false;
          });
...
var CloudRegionCheck = class extends Checker {
  ...
  perform() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      regionStats.sort((a3, b2) => {
        return (a3.duration - b2.duration) * 0.5 + (a3.rtt - b2.rtt) * 0.5;
      });
...
function o2() {
  return o2 = Object.assign ? Object.assign.bind() : function(e3) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n2 = arguments[t2];
      for (var s in n2) ({}).hasOwnProperty.call(n2, s) && (e3[s] = n2[s]);
    }
    return e3;
...
var i = class {
  ...
  constructor(e3, t2) {
    ...
    this.options = void 0, this.connection = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 1, this.canSendFeedback = false, this.endSessionWithDetails = async function(e4) {
      "connected" !== n2.status && "connecting" !== n2.status || (n2.updateStatus("disconnecting"), await n2.handleEndSession(), n2.updateStatus("disconnected"), n2.options.onDisconnect(e4));
    }, this.onMessage = async function(e4) {
      switch (e4.type) {
        case "interruption":
          return void n2.handleInterruption(e4);
        case "agent_response":
          return void n2.handleAgentResponse(e4);
        case "user_transcript":
          return void n2.handleUserTranscript(e4);
        case "internal_tentative_agent_response":
          return void n2.handleTentativeAgentResponse(e4);
        case "client_tool_call":
          return void await n2.handleClientToolCall(e4);
        case "audio":
          return void n2.handleAudio(e4);
        case "ping":
          return void n2.connection.sendMessage({ type: "pong", event_id: e4.ping_event.event_id });
        default:
          return void n2.options.onDebug(e4);
      }
    }, this.setVolume = ({ volume: e4 }) => {
      this.volume = e4;
    }, this.options = e3, this.connection = t2, this.options.onConnect({ conversationId: t2.conversationId }), this.connection.onMessage(this.onMessage), this.connection.onDisconnect(this.endSessionWithDetails), this.updateStatus("connected");
  }
  endSession() {
  ...
  async handleClientToolCall(e3) {
    if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e3.client_tool_call.tool_name)) try {
      var t2;
      const n2 = null != (t2 = await this.options.clientTools[e3.client_tool_call.tool_name](e3.client_tool_call.parameters)) ? t2 : "Client tool execution successful.", s = "object" == typeof n2 ? JSON.stringify(n2) : String(n2);
      this.connection.sendMessage({ type: "client_tool_result", tool_call_id: e3.client_tool_call.tool_call_id, result: s, is_error: false });
    } catch (t3) {
      this.onError(`Client tool execution failed with following error: ${null == t3 ? void 0 : t3.message}`, { clientToolName: e3.client_tool_call.tool_name }), this.connection.sendMessage({ type: "client_tool_result", tool_call_id: e3.client_tool_call.tool_call_id, result: `Client tool execution failed: ${null == t3 ? void 0 : t3.message}`, is_error: true });
    }
    else {
  ...
  sendMCPToolApprovalResult(e3, t2) {
    this.connection.sendMessage({ type: "mcp_tool_approval_result", tool_call_id: e3, is_approved: t2 });
  }
};
var r2 = class {
  constructor(e3 = {}) {
    this.queue = [], this.disconnectionDetails = null, this.onDisconnectCallback = null, this.onMessageCallback = null, this.onDebug = void 0, this.onDebug = e3.onDebug;
  }
  debug(e3) {
    this.onDebug && this.onDebug(e3);
  }
  onMessage(e3) {
  ...
  disconnect(e3) {
    var t2;
    this.disconnectionDetails || (this.disconnectionDetails = e3, null == (t2 = this.onDisconnectCallback) || t2.call(this, e3));
  }
  handleMessage(e3) {
    this.onMessageCallback ? this.onMessageCallback(e3) : this.queue.push(e3);
  }
};
function c(e3) {
  const [t2, n2] = e3.split("_");
  if (!["pcm", "ulaw"].includes(t2)) throw new Error(`Invalid format: ${e3}`);
  const s = Number.parseInt(n2);
  if (Number.isNaN(s)) throw new Error(`Invalid sample rate: ${n2}`);
  return { format: t2, sampleRate: s };
}
function l(e3) {
  return !!e3.type;
}
...
function d(e3) {
  const t2 = { type: u };
  var n2, s, o3, a3, i2;
  return e3.overrides && (t2.conversation_config_override = { agent: { prompt: null == (n2 = e3.overrides.agent) ? void 0 : n2.prompt, first_message: null == (s = e3.overrides.agent) ? void 0 : s.firstMessage, language: null == (o3 = e3.overrides.agent) ? void 0 : o3.language }, tts: { voice_id: null == (a3 = e3.overrides.tts) ? void 0 : a3.voiceId }, conversation: { text_only: null == (i2 = e3.overrides.conversation) ? void 0 : i2.textOnly } }), e3.customLlmExtraBody && (t2.custom_llm_extra_body = e3.customLlmExtraBody), e3.dynamicVariables && (t2.dynamic_variables = e3.dynamicVariables), t2;
}
var h2 = class _h extends r2 {
  constructor(e3, t2, n2, s) {
    super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e3, this.conversationId = t2, this.inputFormat = n2, this.outputFormat = s, this.socket.addEventListener("error", (e4) => {
      ...
      try {
        const t3 = JSON.parse(e4.data);
        if (!l(t3)) return;
        this.handleMessage(t3);
      } catch (e5) {
      }
    });
  }
  static async create(e3) {
    ...
    try {
      var n2;
      const s2 = null != (n2 = e3.origin) ? n2 : "wss://api.elevenlabs.io", o3 = e3.signedUrl ? e3.signedUrl : s2 + "/v1/convai/conversation?agent_id=" + e3.agentId, a3 = ["convai"];
      e3.authorization && a3.push(`bearer.${e3.authorization}`), t2 = new WebSocket(o3, a3);
      const i2 = await new Promise((n3, s3) => {
        t2.addEventListener("open", () => {
          var n4;
          const s4 = d(e3);
          null == (n4 = t2) || n4.send(JSON.stringify(s4));
        }, { once: true }), t2.addEventListener("error", (e4) => {
          setTimeout(() => s3(e4), 0);
        }), t2.addEventListener("close", s3), t2.addEventListener("message", (e4) => {
          const t3 = JSON.parse(e4.data);
          l(t3) && ("conversation_initiation_metadata" === t3.type ? n3(t3.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: r3, agent_output_audio_format: u3, user_input_audio_format: p2 } = i2, m2 = c(null != p2 ? p2 : "pcm_16000"), g2 = c(u3);
      return new _h(t2, r3, m2, g2);
    } catch (e4) {
      var s;
      throw null == (s = t2) || s.close(), e4;
    }
  }
  close() {
    this.socket.close();
...
var p = class _p extends r2 {
  constructor(e3, t2, n2, s, o3 = {}) {
    super(o3), this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.room = void 0, this.isConnected = false, this.room = e3, this.conversationId = t2, this.inputFormat = n2, this.outputFormat = s, this.setupRoomEventListeners();
  }
  static async create(n2) {
    let s;
    if ("conversationToken" in n2 && n2.conversationToken) s = n2.conversationToken;
    else {
      if (!("agentId" in n2) || !n2.agentId) throw new Error("Either conversationToken or agentId is required for WebRTC connection");
      try {
        const e3 = await fetch(`https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=${n2.agentId}`);
        if (!e3.ok) throw new Error(`ElevenLabs API returned ${e3.status} ${e3.statusText}`);
        if (s = (await e3.json()).token, !s) throw new Error("No conversation token received from API");
      } catch (e3) {
        let t2 = e3 instanceof Error ? e3.message : String(e3);
        throw e3 instanceof Error && e3.message.includes("401") && (t2 = "Your agent has authentication enabled, but no signed URL or conversation token was provided."), new Error(`Failed to fetch conversation token for agent ${n2.agentId}: ${t2}`);
      }
    }
    const o3 = new Room();
    try {
      const e3 = `webrtc-${Date.now()}`, a3 = c("pcm_48000"), i2 = c("pcm_48000"), r3 = new _p(o3, e3, a3, i2, n2), l3 = n2.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      await o3.connect(l3, s), await new Promise((e4) => {
        if (r3.isConnected) e4();
        else {
          const n3 = () => {
            o3.off(RoomEvent.Connected, n3), e4();
          };
          o3.on(RoomEvent.Connected, n3);
        }
      ...
      throw await o3.disconnect(), e3;
    }
  }
  setupRoomEventListeners() {
    var e3 = this;
    this.room.on(RoomEvent.Connected, async function() {
      e3.isConnected = true, console.info("WebRTC room connected");
    }), this.room.on(RoomEvent.Disconnected, (e4) => {
      this.isConnected = false, this.disconnect({ reason: "agent", context: new CloseEvent("close", { reason: null == e4 ? void 0 : e4.toString() }) });
    }), this.room.on(RoomEvent.ConnectionStateChanged, (e4) => {
      e4 === ConnectionState.Disconnected && (this.isConnected = false, this.disconnect({ reason: "error", message: `LiveKit connection state changed to ${e4}`, context: new Event("connection_state_changed") }));
    }), this.room.on(RoomEvent.DataReceived, (e4, t2) => {
      try {
        const t3 = JSON.parse(new TextDecoder().decode(e4));
        if ("audio" === t3.type) return;
        l(t3) ? this.handleMessage(t3) : console.warn("Invalid socket event received:", t3);
      } catch (t3) {
        console.warn("Failed to parse incoming data message:", t3), console.warn("Raw payload:", new TextDecoder().decode(e4));
      }
    }), this.room.on(RoomEvent.TrackSubscribed, async function(e4, t2, n2) {
      if (e4.kind === Track.Kind.Audio && n2.identity.includes("agent")) {
        const t3 = e4.attach();
        t3.autoplay = true, t3.controls = false, t3.style.display = "none", document.body.appendChild(t3);
      }
    });
  }
  close() {
  ...
  async sendMessage(e3) {
    if (this.isConnected && this.room.localParticipant) {
      if (!("user_audio_chunk" in e3)) try {
        const t2 = new TextEncoder().encode(JSON.stringify(e3));
        await this.room.localParticipant.publishData(t2, { reliable: true });
      } catch (t2) {
        this.debug({ type: "send_message_error", message: { message: e3, error: t2 } }), console.error("Failed to send message via WebRTC:", t2);
      }
...
async function m(e3) {
  const t2 = function(e4) {
    return e4.connectionType ? e4.connectionType : "conversationToken" in e4 && e4.conversationToken ? "webrtc" : "websocket";
  }(e3);
  switch (t2) {
    case "websocket":
      return h2.create(e3);
    case "webrtc":
      return p.create(e3);
    default:
      throw new Error(`Unknown connection type: ${t2}`);
  }
}
function g() {
  return ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].includes(navigator.platform) || navigator.userAgent.includes("Mac") && "ontouchend" in document;
}
async function f(e3 = { default: 0, android: 3e3 }) {
  let t2 = e3.default;
  var n2;
  if (/android/i.test(navigator.userAgent)) t2 = null != (n2 = e3.android) ? n2 : t2;
  else if (g()) {
    var s;
    t2 = null != (s = e3.ios) ? s : t2;
  }
  t2 > 0 && await new Promise((e4) => setTimeout(e4, t2));
}
var v = class _v extends i {
  static async startSession(e3) {
    const t2 = i.getFullOptions(e3);
    t2.onStatusChange({ status: "connecting" }), t2.onCanSendFeedbackChange({ canSendFeedback: false });
    let n2 = null;
    try {
      return await f(t2.connectionDelay), n2 = await m(e3), new _v(t2, n2);
    } catch (e4) {
      var s;
      throw t2.onStatusChange({ status: "disconnected" }), null == (s = n2) || s.close(), e4;
    }
  }
};
function w(e3) {
...
function y(e3) {
  const t2 = window.atob(e3), n2 = t2.length, s = new Uint8Array(n2);
  for (let e4 = 0; e4 < n2; e4++) s[e4] = t2.charCodeAt(e4);
  return s.buffer;
}
...
function b(e3, t2) {
  return async (n2) => {
    const s = _2.get(e3);
    if (s) return n2.addModule(s);
    const o3 = new Blob([t2], { type: "application/javascript" }), a3 = URL.createObjectURL(o3);
    try {
      return await n2.addModule(a3), void _2.set(e3, a3);
    } catch (e4) {
      URL.revokeObjectURL(a3);
    }
    try {
      const s2 = `data:application/javascript;base64,${btoa(t2)}`;
      await n2.addModule(s2), _2.set(e3, s2);
    } catch (t3) {
...
`);
var C = class _C {
  static async create({ sampleRate: e3, format: t2, preferHeadphonesForIosDevices: n2 }) {
    let s = null, o3 = null;
    try {
      const a4 = { sampleRate: { ideal: e3 }, echoCancellation: { ideal: true }, noiseSuppression: { ideal: true } };
      if (g() && n2) {
        const e4 = (await window.navigator.mediaDevices.enumerateDevices()).find((e5) => "audioinput" === e5.kind && ["airpod", "headphone", "earphone"].find((t3) => e5.label.toLowerCase().includes(t3)));
        e4 && (a4.deviceId = { ideal: e4.deviceId });
      }
      const i3 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      s = new window.AudioContext(i3 ? { sampleRate: e3 } : {});
      const r3 = s.createAnalyser();
      i3 || await s.audioWorklet.addModule("https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js"), await k(s.audioWorklet), o3 = await navigator.mediaDevices.getUserMedia({ audio: a4 });
      const c2 = s.createMediaStreamSource(o3), l3 = new AudioWorkletNode(s, "raw-audio-processor");
      return l3.port.postMessage({ type: "setFormat", format: t2, sampleRate: e3 }), c2.connect(r3), r3.connect(l3), await s.resume(), new _C(s, r3, l3, o3);
    } catch (e4) {
      var a3, i2;
      throw null == (a3 = o3) || a3.getTracks().forEach((e5) => e5.stop()), null == (i2 = s) || i2.close(), e4;
    }
  }
  constructor(e3, t2, n2, s) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.context = e3, this.analyser = t2, this.worklet = n2, this.inputStream = s;
  }
  async close() {
...
var M = class _M {
  static async create({ sampleRate: e3, format: t2 }) {
    let n2 = null;
    try {
      n2 = new AudioContext({ sampleRate: e3 });
      const s2 = n2.createAnalyser(), o3 = n2.createGain();
      o3.connect(s2), s2.connect(n2.destination), await S(n2.audioWorklet);
      const a3 = new AudioWorkletNode(n2, "audio-concat-processor");
      return a3.port.postMessage({ type: "setFormat", format: t2 }), a3.connect(o3), await n2.resume(), new _M(n2, s2, o3, a3);
    } catch (e4) {
      var s;
      throw null == (s = n2) || s.close(), e4;
    }
  }
  constructor(e3, t2, n2, s) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.context = e3, this.analyser = t2, this.gain = n2, this.worklet = s;
  }
  async close() {
...
var F = class _F extends i {
  static async startSession(e3) {
    var t2;
    const n2 = i.getFullOptions(e3);
    n2.onStatusChange({ status: "connecting" }), n2.onCanSendFeedbackChange({ canSendFeedback: false });
    let s = null, a3 = null, r3 = null, c2 = null, l3 = null;
    if (null == (t2 = e3.useWakeLock) || t2) try {
      l3 = await navigator.wakeLock.request("screen");
    } catch (e4) {
    }
    try {
      var u3;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await f(n2.connectionDelay), a3 = await m(e3), [s, r3] = await Promise.all([C.create(o2({}, a3.inputFormat, { preferHeadphonesForIosDevices: e3.preferHeadphonesForIosDevices })), M.create(a3.outputFormat)]), null == (u3 = c2) || u3.getTracks().forEach((e4) => e4.stop()), c2 = null, new _F(n2, a3, s, r3, l3);
    } catch (e4) {
      var d2, h3, p2, g2;
      n2.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e5) => e5.stop()), null == (h3 = a3) || h3.close(), await (null == (p2 = s) ? void 0 : p2.close()), await (null == (g2 = r3) ? void 0 : g2.close());
      try {
        var v2;
        await (null == (v2 = l3) ? void 0 : v2.release()), l3 = null;
      } catch (e5) {
      }
      throw e4;
    }
  ...
  constructor(e3, t2, n2, s, o3) {
    super(e3, t2), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e4) => {
      "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: w(e4.data[0].buffer) });
      ...
      this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: y(e4) });
    }, this.fadeOutAudio = () => {
    ...
    }, this.input = n2, this.output = s, this.wakeLock = o3, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage;
  }
  async handleEndSession() {
...
function I(e3, t2, n2 = "https://api.elevenlabs.io") {
  return fetch(`${n2}/v1/convai/conversations/${e3}/feedback`, { method: "POST", body: JSON.stringify({ feedback: t2 ? "like" : "dislike" }), headers: { "Content-Type": "application/json" } });
}
var D = class extends i {
  static startSession(e3) {
    return e3.textOnly ? v.startSession(e3) : F.startSession(e3);
  }
};
...
function u2() {
  return u2 = Object.assign ? Object.assign.bind() : function(e3) {
    for (var n2 = 1; n2 < arguments.length; n2++) {
      var t2 = arguments[n2];
      for (var r3 in t2) ({}).hasOwnProperty.call(t2, r3) && (e3[r3] = t2[r3]);
    }
    return e3;
...
function a2(a3 = {}) {
  const { micMuted: c2, volume: o3 } = a3, s = function(e3, n2) {
    if (null == e3) return {};
    var t2 = {};
    for (var r3 in e3) if ({}.hasOwnProperty.call(e3, r3)) {
      if (n2.includes(r3)) continue;
      t2[r3] = e3[r3];
    }
    return t2;
  ...
  return (0, import_react.useEffect)(() => {
    ...
    var e3;
    void 0 !== o3 && (null == i2 || null == (e3 = i2.current) || e3.setVolume({ volume: o3 }));
  }, [o3]), (0, import_react.useEffect)(() => () => {
    var e3;
    null == (e3 = i2.current) || e3.endSession();
  }, []), { startSession: async (e3) => {
    var n2;
    if (null != (n2 = i2.current) && n2.isOpen()) return i2.current.getId();
    if (d2.current) return (await d2.current).getId();
    try {
      return d2.current = D.startSession(u2({}, null != s ? s : {}, null != e3 ? e3 : {}, { onModeChange: ({ mode: e4 }) => {
        f2(e4);
      }, onStatusChange: ({ status: e4 }) => {
        p2(e4);
      }, onCanSendFeedbackChange: ({ canSendFeedback: e4 }) => {
        m2(e4);
      } })), i2.current = await d2.current, void 0 !== c2 && i2.current.setMicMuted(c2), void 0 !== o3 && i2.current.setVolume({ volume: o3 }), i2.current.getId();
    } finally {
      d2.current = null;
    }
  }, endSession: async () => {
    ...
    var n2;
    null == (n2 = i2.current) || n2.setVolume({ volume: e3 });
  }, getInputByteFrequencyData: () => {
    var e3;
    ...
    var e3, n2;
    return null != (e3 = null == (n2 = i2.current) ? void 0 : n2.getInputVolume()) ? e3 : 0;
  }, getOutputVolume: () => {
    var e3, n2;
    return null != (e3 = null == (n2 = i2.current) ? void 0 : n2.getOutputVolume()) ? e3 : 0;
  }, sendFeedback: (e3) => {
    var n2;
    null == (n2 = i2.current) || n2.sendFeedback(e3);
  }, getId: () => {
    var e3;
    return null == (e3 = i2.current) ? void 0 : e3.getId();
  }, sendContextualUpdate: (e3) => {
    var n2;
    null == (n2 = i2.current) || n2.sendContextualUpdate(e3);
  }, sendUserMessage: (e3) => {
    var n2;
    null == (n2 = i2.current) || n2.sendUserMessage(e3);
  }, sendUserActivity: () => {
    var e3;
    null == (e3 = i2.current) || e3.sendUserActivity();
  }, sendMCPToolApprovalResult: (e3, n2) => {
    var t2;
    null == (t2 = i2.current) || t2.sendMCPToolApprovalResult(e3, n2);
